      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="border-b border-[var(--border)] bg-[var(--surface)]/60 backdrop-blur-sm px-4 lg:px-8 py-4 lg:py-6 flex items-center gap-3">
          ...
          <button
            ...
            className="p-2 rounded-lg border border-[var(--border)] bg-[var(--surface)] text-[var(--text-muted)] hover:text-[var(--accent-blue)] hover:border-[var(--accent-blue)]/40 transition-colors"
          >
            {darkMode ? (
